...
(function () {
    ...
    function restyleLinkElement(ldata, immediate) {
        ...
        var th = ts.theme(),
            ...
            //  'filter-layer'
            modeCls = ldata.expected() ? 'inactive' : 'filter-layer',//  'filter-layer'
    ...
    function mkObliqueApi(uplink, fltr) {
        return {
            ...
            toggleLayerOffline: toggleOffline,
    ...
    .factory('MeowTopoForceService',
        ['$log', '$timeout', 'FnService', 'SvgUtilService',
            'ThemeService', 'FlashService', 'WebSocketService',
            'MeowTopoOverlayService', 'TopoInstService', 'TopoModelService',
            'TopoD3Service', 'MeowTopoSelectService', 'TopoTrafficService',
            'MeowTopoObliqueService', 'MeowTopoFilterService', 'MeowTopoLinkService',

        function (_$log_, _$timeout_, _fs_, _sus_, _ts_, _flash_, _wss_, _mtov_,
                  _tis_, _tms_, _td3_, _mtss_, _tts_, _mtos_, _mfltr_, _mtls_) {
            $log = _$log_;
            $timeout = _$timeout_;
            fs = _fs_;
            sus = _sus_;
