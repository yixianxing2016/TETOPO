...
(function () {
    ...
    .factory('MeowTopoSelectService',
        ['$log', 'FnService', 'WebSocketService', 'MeowTopoOverlayService',
            'MeowTopoPanelService', 'TopoTrafficService', 'NavService',

        function (_$log_, _fs_, _wss_, _mtov_, _mtps_, _tts_, _ns_) {
            $log = _$log_;
            fs = _fs_;
            wss = _wss_;
            tov = _mtov_;
